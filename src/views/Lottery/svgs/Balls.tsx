...
export const BallWithNumber: React.FC<BallWithNumberProps> = ({ color, number, size, fontSize, rotationTransform, flex, mb }) => {
  const BallComponent = ballsMap[color]
  return (
    <Flex alignItems="center" justifyContent="center" flex={flex || "0 0 24%"} position="relative" mx="2px" mb={mb || "30px"}>

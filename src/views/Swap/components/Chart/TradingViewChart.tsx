...
interface TradingViewChartProps {
  ...
  onTwChartError?: (error: boolean) => void
}
...
const TradingViewChart = ({ outputSymbol, inputSymbol, onTwChartSymbol, onTwChartError }: TradingViewChartProps) => {
